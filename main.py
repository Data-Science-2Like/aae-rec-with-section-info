...
from utils.paths import W2V_PATH, W2V_IS_BINARY, ACM_PATH, CITEWORTH_PATH, DBLP_PATH, CITE2_PATH, CITE5_PATH, AAN_PATH, CITE5_PAPERS_PATH, CITE7_PATH, CITE7_PAPERS_PATH
...
def papers_from_files(dataset, n_jobs=1, use_sdict=True, debug=False):
    ...
    elif dataset == "cite7_papers":
        return load_citeworth(CITE7_PAPERS_PATH, use_sdict)
    elif dataset == "aan":
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str,
                        ...
                        choices=["dblp", "acm", "cite", "cite2", "cite5","cite5_papers", "aan", "cite7", "cite7_papers"])
